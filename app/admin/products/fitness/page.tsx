...
export default function FitnessPage() {
  const subcategories = ["All", "Treadmills", "Crosstrainers", "Exercisebikes", "Massagers"];
  ...
  } = useProductManager("Fitness", subcategories);

  const editButtons = [
    {
      name: "add",
      bgColour: "bg-green-500",
      tooltipValue: "Add Fitness",
      icon: <IoMdAdd />,
      executeFunction: () => {
        setFormData({
          name: "",
  ...
  return (
    <main className="h-[calc(100vh-64px)] flex flex-col overflow-hidden p-6">
      ...
      <div className="flex justify-between items-center mb-4 px-0 sticky top-0">
        <h1 className="text-2xl font-bold text-highlight">Edit Fitness</h1>
