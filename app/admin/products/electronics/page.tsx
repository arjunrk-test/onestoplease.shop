...
export default function ElectronicsPage() {
  const subcategories = ["All", "Smartphones", "Laptops"];
  ...
  } = useProductManager("Electronics", subcategories);

  const editButtons = [
    {
      name: "add",
      bgColour: "bg-green-500",
      tooltipValue: "Add Electronics",
      icon: <IoMdAdd />,
      executeFunction: () => {
        setFormData({
          name: "",
  ...
  return (
    <main className="h-[calc(100vh-64px)] flex flex-col overflow-hidden p-6">
      ...
      <div className="flex justify-between items-center mb-4 px-0 sticky top-0">
        <h1 className="text-2xl font-bold text-highlight">Edit Electronics</h1>
