...
export default function ViewContributions() {
   ...
   return (
      <>
         <Navbar />
         <main className="min-h-[calc(100vh-112px)] bg-background text-foreground p-6 h-screen">
            <OtpLoginDialog />
            {!hydrated ? (
            ...
            <div className="flex items-center justify-between mb-4">
               <div>
                  <h2 className="text-xl font-semibold mb-4 text-highlight">Your Contributions</h2>
               </div>
